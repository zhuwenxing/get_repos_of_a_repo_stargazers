...
args_repo = "IIT-Lab/Paper-with-Code-of-Wireless-communication-Based-on-DL"
args_token = "7727de88bb51b5bc953f48b85667e40022c3b376"
owner = args_repo.split('/')[0]
repo = args_repo.split('/')[1]

headers = {"Authorization": "token "+args_token}
...
# g = Github("zhuwenxing","zwx***19941125")
# g = Github("721f852f864e39247c76dcca84c6d7f25e54b975")
star_list = []
hasNextPage = True
endCursor = "" # Start from begining
count = 0
items = 0
with open('stargazers.csv', 'w', encoding='utf-8') as stars:
